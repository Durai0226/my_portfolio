					...
					<div className="container position-relative z-1 border-top border-1 pb-2 pt-4">
						<div className="text-center">
							<a className="d-flex main-logo align-items-center justify-content-center mb-3">
								...
								<span className="fs-4 ms-2">Duraisingh</span>
							</a>
							<div className="d-flex justify-content-center gap-3">
								<a href="https://www.facebook.com/duraisingh.durai.3/">
									<i className="ri-facebook-circle-fill fs-18" />
								</a>
								<a href="https://x.com/DuraiSinghPandi">
									<i className="ri-twitter-x-fill fs-18" />
								</a>
								<a href="linkedin.com/in/duraisinghpandi-v-320129116">
									<i className="ri-linkedin-fill fs-18" />
								</a>
								<a href="https://github.com/Durai0226">
							...
							<div className="navigation d-flex align-items-center justify-content-center flex-wrap gap-4 my-4">
								...
								<a href="/assets/DuraiSingh__FE.pdf" download className="fs-6"> Resume </a>

												...
												<div className="col-lg-10 col-md-9 mx-auto overflow-hidden">
													...
													<Marquee className="carouselTicker carouselTicker-right position-relative z-1" direction="right">
														...
														<li className="carouselTicker__item mt-6">
																...
																<img src="assets/imgs/home-page-2/hero-1/html.svg" alt="brand" />
															</Link>
														...
														<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																<img src="assets/imgs/home-page-2/hero-1/js.svg" alt="brand" />
															</Link>
														...
														<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
															...
															<li className="carouselTicker__item mt-6">
															<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
															<img src="assets/imgs/home-page-2/hero-1/angular.svg" alt="brand" />
															</Link>
														...
														<li className="carouselTicker__item mt-6">
																<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																<img src="assets/imgs/home-page-2/hero-1/typescript.svg" alt="brand" />
															</Link>
												...
												<div className="col-lg-8 col-md-7 col-10 mx-auto overflow-hidden">
													...
													<Marquee className="carouselTicker carouselTicker-left position-relative z-1">
														<ul className="carouselTicker__list m-0 ">
															...
															<li className="carouselTicker__item mt-6">
															<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																<img src="assets/imgs/home-page-2/hero-1/redux.svg" alt="brand" />
															</Link>
															<span className="tool-tip">Redux</span>
														    </li>
															<li className="carouselTicker__item mt-6">
															<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
															<i className="ri-github-fill fs-50" />
															...
															<li className="carouselTicker__item mt-6">
															<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																<img src="assets/imgs/home-page-2/hero-1/sass.svg" alt="brand" />
															</Link>
															<span className="tool-tip">Sass</span>
														</li>
															
															<li className="carouselTicker__item mt-6">
															<Link href="#" className="brand-logo icon_80 icon-shape rounded-3">
																<img src="assets/imgs/home-page-2/hero-1/bootstarp.svg" alt="brand" />
															</Link>
															<span className="tool-tip">Bootstarp</span>
                          ...
                          <ul className="ps-3 d-flex flex-column justify-content-between h-100 position-relative">
                            ...
                            <li className="mb-3">
                              <div className="d-flex flex-column flex-md-row gap-2">
                                ...
                                <span className="text-300">React, Redux, Angular</span>
                              </div>
                            </li>
                            <li className="mb-3">
                              <div className="d-flex flex-column flex-md-row gap-2">
                                <p className="text-dark text-nowrap mb-0">Design Frameworks:</p>
                                <span className="text-300">Bootstrap, Ant Design, Tailwind CSS, SASS</span>
                              </div>
                            </li>
                            <li className="mb-3">
                              <div className="d-flex flex-column flex-md-row gap-2">
                                <p className="text-dark text-nowrap mb-0">Technologies:</p>
                                <span className="text-300">WebRTC, REST API, WebSockets</span>
                              </div>
                            </li>
                            <li className="mb-3">
                              <div className="d-flex flex-column flex-md-row gap-2">
